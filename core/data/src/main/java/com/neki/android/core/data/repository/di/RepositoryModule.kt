...
import com.neki.android.core.data.repository.impl.PhotoBoothRepositoryImpl
...
internal interface RepositoryModule {
    ...
    @Binds
    @Singleton
    fun bindPhotoBoothRepositoryImpl(
        photoBoothRepositoryImpl: PhotoBoothRepositoryImpl,
